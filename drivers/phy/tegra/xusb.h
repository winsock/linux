...
struct tegra_xusb_utmi_lane {
	struct tegra_xusb_lane base;

	u32 hs_curr_level_offset;
};

static inline struct tegra_xusb_utmi_lane *
to_utmi_lane(struct tegra_xusb_lane *lane)
{
	return container_of(lane, struct tegra_xusb_utmi_lane, base);
}
...
static inline struct tegra_xusb_utmi_pad *
to_utmi_pad(struct tegra_xusb_pad *pad)
{
	return container_of(pad, struct tegra_xusb_utmi_pad, base);
}
...
static inline struct tegra_xusb_utmi_port *
to_utmi_port(struct tegra_xusb_port *port)
{
	return container_of(port, struct tegra_xusb_utmi_port, base);
}

struct tegra_xusb_utmi_port *
tegra_xusb_find_utmi_port(struct tegra_xusb_padctl *padctl,
			  unsigned int index);
